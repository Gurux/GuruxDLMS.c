...
#define GX_ENUM(X) GX_UNION(&X, bVal, DLMS_DATA_TYPE_ENUM)
#ifdef DLMS_IGNORE_MALLOC
...
#define GX_ARRAY(X, VALUE_) GX_UNION2(&X, Arr = &VALUE_, (DLMS_DATA_TYPE)(DLMS_DATA_TYPE_BYREF | DLMS_DATA_TYPE_ARRAY), 0, 0)
#define GX_STRUCT(X, VALUE_) GX_UNION2(&X, Arr = &VALUE_, (DLMS_DATA_TYPE)(DLMS_DATA_TYPE_BYREF | DLMS_DATA_TYPE_STRUCTURE), 0, 0)
#endif //DLMS_IGNORE_MALLOC
